        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">+1 (888) 579-6686</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-r from-primary-500 to-primary-600 rounded-lg flex items-center justify-center mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">7025 Tomken Rd, Mississauga, Ontario L5T 2J8, Canada</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-effect rounded-2xl p-6">
              <h4 className="text-lg font-bold text-white mb-4">Strategic Holdings</h4>
              <div className="space-y-3">
                <div className="flex items-center">
                  <Star className="w-4 h-4 text-accent-green mr-3" />
                  <span className="text-white/80 text-base">SaaS and PaaS Deployment Models</span>
                </div>
                <div className="flex items-center">
                  <Star className="w-4 h-4 text-accent-cyan mr-3" />
                  <span className="text-white/80 text-base">AI-Enabled Enterprise Solutions</span>
                </div>
                <div className="flex items-center">
                  <Star className="w-4 h-4 text-accent-purple mr-3" />
                  <span className="text-white/80 text-base">Market Intelligence & Strategic Positioning</span>
                </div>
              </div>
            </div>
          </div>
